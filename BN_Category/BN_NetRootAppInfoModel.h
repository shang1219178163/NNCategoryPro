...
@class BN_NetResultsAppInfoModel;
@interface BN_NetRootAppInfoModel : NSObject

@property (nonatomic, strong) NSArray<BN_NetResultsAppInfoModel *> *results;
@property (nonatomic, assign) NSInteger resultCount;

@end
@interface BN_NetResultsAppInfoModel : NSObject
